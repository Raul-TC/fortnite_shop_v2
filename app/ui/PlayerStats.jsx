...
const PlayerStats = ({ stats }) => {
  ...
  console.log(stats.stats.season.squad === null)
  return (
    <div className='mt-4'>
      ...
      <div className='my-4'>
        <div className='flex w-full flex-col md:flex-row items-start justify-start flex-wrap self-start gap-4'>
          <StatCard wins={stats.stats.season.solo.wins} kills={stats.stats.season.solo.kills} top10={stats.stats.season.solo.top10} top25={stats.stats.season.solo.top25} deaths={stats.stats.season.solo.deaths} kda={stats.stats.season.solo.kd} matches={stats.stats.season.solo.matches} winrate={stats.stats.season.solo.winRate} timePlayed={handleMinutes(stats.stats.season.solo.minutesPlayed)} updated={formatedDate(new Date(stats.stats.season.solo.lastModified))} modo='Solo' />
          <StatCard wins={stats.stats.season.duo.wins} kills={stats.stats.season.duo.kills} top10={stats.stats.season.duo.top5} top25={stats.stats.season.duo.top12} deaths={stats.stats.season.duo.deaths} kda={stats.stats.season.duo.kd} matches={stats.stats.season.duo.matches} winrate={stats.stats.season.duo.winRate} timePlayed={handleMinutes(stats.stats.season.duo.minutesPlayed)} updated={formatedDate(new Date(stats.stats.season.duo.lastModified))} modo='Duo' />
          {stats.stats.season.squad && <StatCard wins={stats.stats.season.squad?.wins ?? 0} kills={stats.stats.season.squad?.kills} top10={stats.stats.season.squad?.top3} top25={stats.stats.season.squad?.top6} deaths={stats.stats.season.squad?.deaths} kda={stats.stats.season.squad?.kd} matches={stats.stats.season.squad?.matches} winrate={stats.stats.season.squad?.winRate} timePlayed={handleMinutes(stats.stats.season.squad?.minutesPlayed)} updated={formatedDate(new Date(stats.stats.season.squad?.lastModified))} modo='Squad' />}
        </div>
      </div>
      ...
      <div className='flex w-full flex-col md:flex-row items-center justify-center flex-wrap gap-4'>
        ...
        {stats.stats.lifetime.squad && <StatCard wins={stats.stats.lifetime.squad?.wins ?? 0} kills={stats.stats.lifetime.squad?.kills} top10={stats.stats.lifetime.squad?.top3} top25={stats.stats.lifetime.squad?.top6} deaths={stats.stats.lifetime.squad?.deaths} kda={stats.stats.lifetime.squad?.kd} matches={stats.stats.lifetime.squad?.matches} winrate={stats.stats.lifetime.squad?.winRate} timePlayed={handleMinutes(stats.stats.lifetime.squad?.minutesPlayed)} updated={formatedDate(new Date(stats.stats.lifetime.squad?.lastModified))} modo='Squad' />}
      </div>
    </div>
  )
}
