  ...
  return (
    <div className='mt-4'>
      ...
      <div className='flex w-full flex-col md:flex-row items-start justify-start flex-wrap self-start gap-4'>
        {stats.season.solo && <StatCard wins={stats.season.solo?.wins} kills={stats.season.solo?.kills} top10={stats.season.solo?.top10} top25={stats.season.solo?.top25} deaths={stats.season.solo?.deaths} kda={stats.season.solo?.kd} matches={stats.season.solo?.matches} winrate={stats.season.solo?.winRate} timePlayed={handleMinutes(stats.season.solo?.minutesPlayed)} updated={handleLocalDate(stats.season.solo?.lastModified)} modo='Solo' />}
